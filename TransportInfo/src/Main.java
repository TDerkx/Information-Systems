...
public class Main {
    ...
    PreparedStatement queryAllRoutes(String country) throws SQLException {
        String query = "SELECT * FROM transportdata WHERE countryfrom = \'" + country + "\' AND countryto = \'" +
                country + "\' FETCH FIRST 100 ROWS ONLY;"; // only draw 100 so it doesnt slow too much
